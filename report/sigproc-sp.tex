...
\title{Project in Advanced Embedded Systems Self Evaluation\titlenote{This self evaluation report was
        written during the autumn of 2013 in the advanced level project course
        "DVA425 - Project in Advanced Embedded Systems" at M\"{a}lardalen University, Sweden.}}
...
\input{first_period.tex}
\input{second_period.tex}
\input{third_period.tex}
\input{fourth_period.tex}
\input{fifth_period.tex}
\input{final_evaluation.tex}
